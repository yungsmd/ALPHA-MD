...
keith({
  ...
  const { repondre, ms } = commandeOptions;
  const url = 'https://smiling-hosiery-bear.cyclic.app/weeb/couplepp'; // Replace with your actual URL
...
keith({
  ...
  const { repondre, ms } = commandeOptions;
  const url = 'https://fantox-cosplay-api.onrender.com'; // Replace with your actual URL
...
keith({
  ...
  const { repondre, ms } = commandeOptions;
  const url = 'https://api.waifu.pics/nsfw/shinobu'; // Replace with your actual URL
